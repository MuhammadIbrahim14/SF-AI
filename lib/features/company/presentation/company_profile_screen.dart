...
class CompanyProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const profileView = RoleProfileView(
      ...
      editRouteName: RouteNames.companyEditProfile,
    );
...
class _PremiumGlassHintsPanelState extends State<_PremiumGlassHintsPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = AppColors.companyPrimary;
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Complete your company profile to establish trust and attract top talent.',
            ...
            ProfileInfoCard(
              ...
              children: [
                const ProfileLinkTile(
                  ...
                  value: 'Verify your company details',
                ),
                const ProfileLinkTile(
                  label: 'Applicant Pipeline',
                  icon: Icons.people_outline_rounded,
                  value: 'Manage job candidates',
                ),
                const ProfileLinkTile(
                  label: 'Company Culture',
                  icon: Icons.diversity_3_outlined,
                  value: 'Add photos and perks',
                ),
