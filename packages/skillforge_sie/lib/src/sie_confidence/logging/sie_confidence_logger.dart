...
/// Structured logging for the Confidence Engine.
abstract interface class SieConfidenceLogger {
  /// Info.
...
final class DeveloperSieConfidenceLogger implements SieConfidenceLogger {
  /// Creates the logger.
  ...
  static String _format(
    ...
    final buf = StringBuffer('[sie.confidence][$level] $event');
...
final class NopSieConfidenceLogger implements SieConfidenceLogger {
