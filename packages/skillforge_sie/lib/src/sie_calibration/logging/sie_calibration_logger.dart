...
/// Structured logging for the Calibration Engine.
abstract interface class SieCalibrationLogger {
  /// Info.
...
final class DeveloperSieCalibrationLogger implements SieCalibrationLogger {
  /// Creates the logger.
  ...
  static String _format(
    ...
    final buf = StringBuffer('[sie.calibration][$level] $event');
...
final class NopSieCalibrationLogger implements SieCalibrationLogger {
