...
/// Structured logging for the Intent Engine.
abstract interface class SieIntentLogger {
  /// Info.
...
final class DeveloperSieIntentLogger implements SieIntentLogger {
  /// Creates the logger.
  ...
  static String _format(
    ...
    final buf = StringBuffer('[sie.intent][$level] $event');
...
final class NopSieIntentLogger implements SieIntentLogger {
