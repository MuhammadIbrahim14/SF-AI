...
/// Structured logging for the Integration Framework (never per-interaction).
abstract interface class SieIntegrationLogger {
  /// Info.
...
final class DeveloperSieIntegrationLogger implements SieIntegrationLogger {
  /// Creates logger.
  ...
  static String _format(
    ...
    final buf = StringBuffer('[sie.integration][$level] $event');
...
final class NopSieIntegrationLogger implements SieIntegrationLogger {
  /// Creates logger.
